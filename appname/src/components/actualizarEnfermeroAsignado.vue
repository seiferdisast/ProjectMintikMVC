<template>
    <div class="signupFrm">
      <form v-on:submit.prevent="actualizarEnfermero" class="form">
        <h1 class="title">Actualizar Enfermero Asignado</h1>
  ...
  export default {
    ...
    data: function () {
      return {
        user: {
          documentId: "79546897",
          name: "Daniel Alberto",
          lastName: "Sánchez Montaño",
          cellularPhone: "3202587952",
          address: "Calle 89 uijdbb",
    ...
    methods: {
      actualizarEnfermero (){
        ...
        axios.patch("http://127.0.0.1:8000/user/79546897/update/", post).then(result =>{

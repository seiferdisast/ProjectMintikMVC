...
<template>
    <div class="signupFrm">
      <form v-on:submit.prevent="actualizarDoctor" class="form">
        <h1 class="title">Actualizar Doctor Asignado</h1>
  ...
  export default {
    name: 'actualizarDoctorasignado',
  
    data: function () {
      return {
        user: {
          documentId: "1020292919",
          name: "Camila",
          lastName: "Jimenez",
          cellularPhone: "1313131313",
          address: "saddasd",
          email: "danidasdasd",
          role: "Paciente",
          password: "321312321",
    ...
    methods: {
      actualizarDoctor (){
        ...
        axios.patch("http://127.0.0.1:8000/user/1020292919/update/", post).then(result =>{

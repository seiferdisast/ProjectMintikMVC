...
<template>
    <div class="signupFrm">
      <form v-on:submit.prevent="actualizarFamiliar" class="form">
        <h1 class="title">Actualizar Datos Personales Familiar</h1>
  ...
  export default {
    ...
    methods: {
      actualizarFamiliar (){
        ...
        axios.patch("http://127.0.0.1:8000/user/5656/update/", post).then(result =>{
